...
## Untuk mengimport Media
img_dir = path.join(path.dirname(__file__), 'assets') #untuk mengimport gambar dari file 'assets'
sound_folder = path.join(path.dirname(__file__), 'sounds') #untuk mengimport gambar dari file 'sounds'
...
pygame.init()
pygame.mixer.init()  ## initialize For sound system
...
def main_menu():
    ...
    while True:
        ...
        if ev.type == pygame.KEYDOWN:
            ...
            draw_text(screen, "Press [Space] To Shoot", 30, WIDTH/2, (HEIGHT/2)+40)
            pygame.display.update()
...
player_mini_img = pygame.transform.scale(player_img, (45, 32))
